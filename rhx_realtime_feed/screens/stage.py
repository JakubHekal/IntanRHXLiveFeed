...
class RightSidebar(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        self._block_start.setRange(0.0, 999999.0)
        self._block_start.setSuffix(" s")
        self._block_start.setSingleStep(30.0)
        self._block_start.setDecimals(1)
        self._block_dur = QDoubleSpinBox()
        self._block_dur.setRange(0.0, 999999.0)
        self._block_dur.setSuffix(" s")
        self._block_dur.setSingleStep(30.0)
